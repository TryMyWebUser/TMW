			...
			<div class="container">
				<div class="row masonary-layout">
					...
					<?php
						...
						$project = iterator_to_array($result);
						if (!empty($project)) {
						...
						<div class="project-one__single">
							<div class="project-one__img-box">
								...
								<div class="project-one__content">
									...
									<h3 class="project-one__title"><a href="<?= $pro['links']; ?>"><?= $pro['title']; ?></a>
									</h3>
								</div>
								<!-- <div class="project-one__view">
										<div class="project-one__view-shape">
											<img src="admin/<?= $pro['img']; ?>" alt="Image not found">
										</div>
										<a href="admin/<?= $pro['img']; ?>" class="img-popup">View
											<br> Project<span class="icon-long-bottom-arrow"></span></a>
								</div> -->
							</div>
						</div>
					</div>

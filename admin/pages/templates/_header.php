    ...
    <ul class="nav">
        ...
        <li class="nav-item">
            <a class="nav-link" data-toggle="collapse" href="#Careers" aria-expanded="false" aria-controls="Careers">
                <!-- <i class="icon-columns menu-icon"></i> -->
                <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" class="bi bi-crosshair" style="margin-right: 1rem;" viewBox="0 0 16 16">
                    <path d="M8.5.5a.5.5 0 0 0-1 0v.518A7 7 0 0 0 1.018 7.5H.5a.5.5 0 0 0 0 1h.518A7 7 0 0 0 7.5 14.982v.518a.5.5 0 0 0 1 0v-.518A7 7 0 0 0 14.982 8.5h.518a.5.5 0 0 0 0-1h-.518A7 7 0 0 0 8.5 1.018zm-6.48 7A6 6 0 0 1 7.5 2.02v.48a.5.5 0 0 0 1 0v-.48a6 6 0 0 1 5.48 5.48h-.48a.5.5 0 0 0 0 1h.48a6 6 0 0 1-5.48 5.48v-.48a.5.5 0 0 0-1 0v.48A6 6 0 0 1 2.02 8.5h.48a.5.5 0 0 0 0-1zM8 10a2 2 0 1 0 0-4 2 2 0 0 0 0 4"/>
                </svg>
                <span class="menu-title">Careers Page</span>
                <i class="menu-arrow"></i>
            </a>
            <div class="collapse" id="Careers">
                <ul class="nav flex-column sub-menu rounded-bottom">
                    <li class="nav-item"><a class="nav-link" href="addCareer.php">Add Careers</a></li>
                    <li class="nav-item"><a class="nav-link" href="viewCareer.php">View Careers</a></li>
                </ul>
            </div>
        </li>
    </ul>

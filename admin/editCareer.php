...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    if (isset($_POST['submit']) && isset($_POST['title']) && isset($_POST['dec']) && isset($_POST['category'])) {
        ...
        // SQL Query: Directly updating without prepared statements
        $sql = "UPDATE `career` SET `title` = '$title', `dec` = '$dec', `category` = '$cate', `created_at` = NOW() WHERE `id` = '$getID'";
                                                ...
                                                <form class="forms-sample" method="POST">
                                                    <div class="form-group">
                                                        ...
                                                        <select name="category">
                                                            <option value="<?= $career['category'] ?>">Select Category</option>
                                                    ...
                                                    <div class="form-group">
                                                        ...
                                                        <input type="text" name="title" class="form-control" placeholder="Title" value="<?= $career['title'] ?>">
                                                    </div>
                                                    <div class="form-group">
                                                        <label for="exampleTextarea1">Description</label>
                                                        <textarea class="form-control" name="dec" id="exampleTextarea1" placeholder="Description" rows="4"><?= $career['dec'] ?></textarea>
                                                    </div>

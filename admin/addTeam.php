...
if ($_SERVER['REQUEST_METHOD'] === 'POST')
{
    if (isset($_POST['submit']) && isset($_POST['name']) && isset($_POST['role']) && isset($_FILES['img']))
    {
        ...
        $role = $_POST['role'];
        $img = $_FILES['img'];
        $result = Operations::setTeamMembers($name, $role, $img);
    }
}
                            ...
                            <div class="col-md-12 grid-margin">
                                <div class="row">
                                    <div class="col-12 col-xl-8 mb-4 mb-xl-0">
                                        <div class="card">
                                            <div class="card-body">
                                                <h4 class="card-title">Team Members Upload</h4>
                                                ...
                                                <form class="forms-sample" method="POST" enctype="multipart/form-data">
                                                    ...
                                                    <div class="form-group">
                                                        ...
                                                        <div class="input-group col-xs-12">
                                                            <input type="file" name="img" class="file-upload-browse btn btn-light" placeholder="User Image Upload" accept="image/*" required> 
                                                        </div>
                                                    </div>
